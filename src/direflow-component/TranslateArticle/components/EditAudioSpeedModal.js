...
export default class EditAudioSpeedModal extends React.Component {
    state = {
        open: false,
        slideValue: 'slide',
        value: 1,
        ...
        return (
            <Modal
                ...
                trigger={
                    ...
                    >
                        <strong>
                            Audio Speed: {parseFloat(this.props.value).toFixed(2)}x
                        </strong>
                        <Button
                            circular
                            basic
                        ...
                        <Grid.Row style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <Grid.Column width={4}>
                              <Dropdown
                                ...
                                options={[{ key: 'audio-speed-' + this.props.slideIndex, value: 'slide', text: `Slide ${this.props.slideIndex + 1}`},{ key: 'audio-speed-all', value: 'all', text: 'All Slides'}]} 
